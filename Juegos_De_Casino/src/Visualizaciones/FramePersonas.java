...
import Clases.PersonaUno;
import Clases.PersonaDos;
import Clases.PersonaTres;
...
public class FramePersonas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblPersonaUno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/IUno.jpg"))); // NOI18N
        lblPersonaUno.setText("jLabel1");

        lblPersonaDos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/IDos.jpg"))); // NOI18N
        lblPersonaDos.setText("jLabel1");

        lblPersonaTres.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ITres.jpg"))); // NOI18N
        lblPersonaTres.setText("jLabel1");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnIniciar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarActionPerformed
         ...
         tiempoMilisegundos = switch (cbDificultad.getSelectedIndex()) {
                case 0 -> 0;
                case 1 -> 100;
                case 2 -> 500;
                default -> 0;
            };
        p1 = new PersonaUno(tiempoMilisegundos);
        p2 = new PersonaDos(tiempoMilisegundos);
        p3 = new PersonaTres(tiempoMilisegundos);
        respuesta1 = false;
        respuesta2 = false;
        respuesta3 = false;
